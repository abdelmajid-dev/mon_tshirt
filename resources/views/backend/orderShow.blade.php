    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="table-responsive">
            <div class="jumbotron">
                ...
                <p>{{$order->adresse->adresse}} <br>{{$order->adresse->adresse}}
                <br> {{$order->adresse->code_postal}} - {{$order->adresse->ville}} - {{$order->adresse->pays}}</p>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        {{number_format($product->pivot->prix_total_ttc,2)}}€ TTC</td>
                </tr>
                    @endforeach
                </tbody>
                <tfoot>
