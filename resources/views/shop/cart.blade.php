    ...
    <section class="py-5">
        <div class="container">
            ...
            <table class="table table-bordered table-responsive-sm">
                ...
                <tr>
                    <td>
                        ...
                        <a href="{{route('cart_remove',['id'=>$product->id])}}"
                    ...
                    <td>
                        ...
                        <input name="qty" style="display: inline-block" id="qte" class="form-control col-sm-4 change_qty" type="number" value="{{$product->quantity}}" min="1">
            ...
            <a class="btn btn-block btn-outline-dark"
               href="{{route('order_auth')}}">Commander</a>
                @else
                <p>Votre panier est tristement vide ... <a href="{{route('homepage')}}">Continuer mes achats</a></p>
            @endif
        </div>
    </section>
@endsection