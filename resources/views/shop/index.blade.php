            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">{{$product->nom}} <br>{{$product->description}} <br> Catégorie:
  <a href="{{route('voir_produits_par_categorie',['id'=>$product->category->id])}}">
      {{ $product->category->nom }}</a>    </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="price">{{ $product->prixTTC() }}</span>
          <a href="{{ route('voir_produit',['id'=>$product->id] ) }}"
